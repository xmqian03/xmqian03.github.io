...
I am a core contributor to the [MOSS-VL](https://github.com/OpenMOSS/MOSS-VL) model family, where I work on training data end to end. I built the team's data infrastructure — preprocessing and deduplication pipelines, MongoDB schema iteration and import/export flows — and I own training-data assembly and versioned delivery across pre-training stages and SFT. I also develop data assembly tooling (asb), design large-scale data synthesis and enhancement pipelines (image/video captioning, model identity data, needle-in-a-haystack tasks), and contribute to the team's data governance system.
