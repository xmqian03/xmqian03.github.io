...
I am a core contributor to the [MOSS-VL](https://github.com/OpenMOSS/MOSS-VL) model family, where I work on training data across the full pipeline — data infrastructure, assembly and delivery, and data synthesis — spanning both pre-training and post-training stages.
